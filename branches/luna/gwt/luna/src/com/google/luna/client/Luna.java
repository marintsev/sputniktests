...
public class Luna implements EntryPoint {
	...
	private static final Map<String, ITestController> CONTROLLERS = new HashMap<String, ITestController>() {{
		put("sputnik", new SputnikTestController());
	}};
	...
	public static ITestController getTestController(String type) {
